  ...
  return knex('tasks').truncate()
    .then(function () {
      return knex('tasks').insert([
        ...
        { project_id: "1", description: "Remove wiring to starter", completed: "", notes: "" },
        { project_id: "1", description: "Remove start", completed: "", notes: "" },
        { project_id: "1", description: "Install new starter", completed: "", notes: "" },
        { project_id: "1", description: "Re-install battery", completed: "", notes: "Be sure to clean battery terminal connections" },
        { project_id: "1", description: "Test", completed: "", notes: "" },
        ...
        { project_id: "2", description: "Code front-end", completed: "", notes: "" },
        { project_id: "2", description: "Deploy", completed: "", notes: "" },
